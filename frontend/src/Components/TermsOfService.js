...
const TermsOfService = () => {
  return (
    <Container maxWidth="md" sx={{ py: 8 }}>
      <Typography variant="h3" component="h1" gutterBottom sx={{ fontFamily: "'Fredoka', sans-serif", color: "var(--chili)", fontWeight: "bold" }}>
        Terms of Service
      </Typography>
      ...
      <Box sx={{ mt: 4 }}>
        <Typography variant="h5" gutterBottom sx={{ fontFamily: "'Fredoka', sans-serif", fontWeight: "bold", mt: 3 }}>
          1. Introduction
        </Typography>
